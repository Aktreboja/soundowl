    ...
    <Dialog.Root open={isOpen} onOpenChange={(e) => setIsOpen(e.open)}>
      <Dialog.Trigger asChild>
        <button className="relative group cursor-pointer">
          <div className="relative w-10 h-10 rounded-full overflow-hidden ring-1 ring-transparent group-hover:ring-emerald-500 transition-all duration-200">
            {!navImageLoaded && (
              <SkeletonCircle
            ...
            <Image
              ...
              width={40}
              height={40}
              className={`w-full h-full object-cover transition-opacity duration-200 ${navImageLoaded ? 'opacity-100' : 'opacity-0'}`}
            ...
            <div className="relative -mt-12 flex justify-center">
              <div className="relative w-24 h-24 rounded-full overflow-hidden ring-4 ring-white dark:ring-gray-900 shadow-lg">
                ...
                <Image
                  ...
                  width={96}
                  height={96}
                  className={`w-full h-full object-cover transition-opacity duration-200 ${dialogImageLoaded ? 'opacity-100' : 'opacity-0'}`}
